...
export class Component {
    ...
    /**
     * Called by the Component constructor to create an element out of the components's HTML.
     * You MUST override this method in your components subclasses
     */
    getTemplate() {
    ...
    /**
     * returns the HTML element that was created for this components out of getTemplate()
     * @returns {HTMLElement}
     */
    getElement() {
        return this._elt;
